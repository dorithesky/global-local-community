      ...
      <section className="grid gap-6 xl:grid-cols-[260px_minmax(0,1fr)] xl:items-start">
        <aside className="xl:sticky xl:top-6 space-y-4">
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Admin sections</p>
            <nav className="mt-3 space-y-2 text-sm">
              <a href="#overview" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Overview</a>
              <a href="#moderation-queue" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Moderation queue</a>
              <a href="#member-operations" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Member operations</a>
              <a href="#admin-watchlist" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Admin watchlist</a>
              <a href="#community-activity" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Community activity</a>
              <a href="#audit-trail" className="block rounded-2xl bg-slate-100 px-3 py-2 text-slate-700 hover:bg-slate-200">Audit trail</a>
            </nav>
          </div>
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Admin reminder</p>
            <p className="mt-3 text-sm leading-6 text-slate-600">This area remains server-gated and should stay accessible to admins only.</p>
          </div>
        </aside>
