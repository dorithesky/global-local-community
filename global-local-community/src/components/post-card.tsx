        ...
        {typeof post.rank === 'number' ? (
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-[11px] font-medium text-[var(--text-tertiary)]">
              <span className={`inline-flex items-center gap-1 rounded-full border px-2.5 py-1 text-[10px] font-semibold leading-none shadow-sm ${post.rank === 1 ? 'border-amber-200 bg-amber-50 text-amber-950 dark:border-amber-500/20 dark:bg-amber-500/15 dark:text-amber-200' : post.rank === 2 ? 'border-indigo-200 bg-indigo-50 text-indigo-950 dark:border-indigo-500/20 dark:bg-indigo-500/15 dark:text-indigo-200' : post.rank === 3 ? 'border-teal-200 bg-teal-50 text-teal-950 dark:border-teal-500/20 dark:bg-teal-500/15 dark:text-teal-200' : 'border-[var(--border-subtle)] bg-[var(--surface-muted)] text-[var(--text-primary)]'}`}>
