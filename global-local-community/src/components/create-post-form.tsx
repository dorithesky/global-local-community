...
export function CreatePostForm({
  ...
  return (
    <form action={action} className="space-y-5 rounded-3xl border border-sky-100 bg-gradient-to-br from-white to-sky-50/40 p-5 shadow-sm">
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label className="mb-2 block text-sm font-medium text-slate-900">City</label>
          <select name="city" defaultValue={city} className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring">
        ...
        <div>
          ...
          <input name="district" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring" placeholder="Mapo-gu, Haeundae-gu, Suseong-gu" />
        </div>
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium text-slate-900">Category</label>
        <select name="category" defaultValue="housing" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring">
      ...
      <div>
        ...
        <input name="title" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring" placeholder="Need a short-term officetel near Banwoldang" />
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium text-slate-900">Body</label>
        <textarea
          name="body"
          className="min-h-40 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring"
      ...
      <div>
        ...
        <input name="tags" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-sky-200 focus:ring" placeholder="housing, newcomer, near-subway" />
      </div>
      <div>
      ...
      <div className="rounded-2xl border border-sky-200 bg-white/80 p-4 text-sm text-sky-900 shadow-sm">
